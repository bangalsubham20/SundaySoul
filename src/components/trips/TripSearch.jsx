      ...
      <div className={`relative rounded-lg overflow-hidden transition-all duration-300 ${
        ...
        <div className="flex items-center bg-white px-4 py-3">
          ...
          <input
            ...
            className="flex-1 ml-3 outline-none text-gray-800 placeholder-gray-500 text-base"
          />
        ...
        {isFocused && searchTerm && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-full left-0 right-0 bg-white border-b border-l border-r border-gray-200 rounded-b-lg shadow-lg"
          >
