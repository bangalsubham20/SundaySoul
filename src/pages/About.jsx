...
const About = () => {
    ...
    return (
        <div className="min-h-screen bg-teal-900 text-grey-400 font-sans selection:bg-cyan-500 selection:text-teal-900 pt-20">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    <motion.p
                        ...
                        className="text-cyan-400 font-bold tracking-[0.2em] uppercase mb-4"
                    >
                        Our Story
                    </motion.p>
                    <motion.h1
                        ...
                        className="text-5xl md:text-7xl font-display text-white mb-6 drop-shadow-2xl"
                    >
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl font-light text-grey-300 leading-relaxed"
                    >
            ...
            {/* Stats Section */}
            <section className="py-20 bg-teal-800/30 border-y border-white/5 backdrop-blur-md">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        ...
                        >
                            <h3 className="text-4xl md:text-5xl font-display text-white mb-2">{stat.value}</h3>
                            <p className="text-cyan-500 font-bold uppercase tracking-wider text-xs md:text-sm">{stat.label}</p>
                        </motion.div>
                    ))}
                </div>
            </section>
            ...
            <section className="py-24 px-6 relative overflow-hidden">
                {/* Background Elements */}
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-cyan-500/5 rounded-full blur-[100px] translate-x-1/2 -translate-y-1/2 pointer-events-none" />
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-teal-500/5 rounded-full blur-[100px] -translate-x-1/2 translate-y-1/2 pointer-events-none" />

                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-display text-white mb-6">Our Core Values</h2>
                        <p className="max-w-2xl mx-auto text-lg font-light text-grey-400">
                        ...
                        {values.map((value, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    whileHover={{ y: -10 }}
                                    viewport={{ once: true }}
                                    className="p-8 rounded-[2rem] bg-white/5 border border-white/5 hover:border-cyan-500/30 hover:bg-white/10 transition-all duration-300 group"
                                >
                                    <div className="w-14 h-14 rounded-2xl bg-teal-900 border border-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                        <Icon className="text-cyan-400" size={24} />
                                    </div>
                                    <h3 className="text-xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors">{value.title}</h3>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div>
                            ...
                            <p className="text-lg font-light text-grey-400 max-w-xl">
                                The dreamers, planners, and adventurers behind your next favorite memory.
                            </p>
                        </div>
                        <button className="flex items-center gap-2 text-cyan-400 font-bold uppercase tracking-wider hover:text-white transition-colors group">
            ...
            <section className="py-24 px-6 text-center">
                <div className="max-w-4xl mx-auto bg-gradient-to-r from-cyan-900/40 to-teal-900/40 border border-white/10 p-12 md:p-20 rounded-[3rem] backdrop-blur-xl relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-full bg-[url('/patterns/noise.png')] opacity-[0.03] pointer-events-none" />
                    <div className="relative z-10">
                        <h2 className="text-4xl md:text-6xl font-display text-white mb-6">Ready to start your journey?</h2>
                        <p className="text-xl text-grey-400 mb-10 max-w-2xl mx-auto font-light">
                            Join thousands of others who have found their Sunday Soul with us. The world is waiting.
                        </p>
                        <button className="px-10 py-4 bg-cyan-500 hover:bg-cyan-400 text-teal-900 font-bold text-lg rounded-full shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all hover:-translate-y-1">
                            Explore Expeditions
                        </button>
                    </div>
                </div>
